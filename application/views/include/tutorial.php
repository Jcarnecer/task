<div id="tutorialModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="box-shadow: 0 0 10px rgba(0,0,0,0.2);">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <div class="card border-0 rounded-0">
                            <img src="<?= base_url('assets/tutorial/task.png') ?>" alt="Sidebar" class="rounded-0 card-img-top">
                            <div class="card-body">
                                <h5 class="card-title">Tasks</h5>
                                <p class="card-text">Each task is located within a column for an organized view.</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                    ...
                    <div class="carousel-item">
                        <div class="card border-0 rounded-0">
                            <img src="<?= base_url('assets/tutorial/add note.png') ?>" alt="Account" class="rounded-0 card-img-top">
                            <div class="card-body">
                                <h5 class="card-title">Adding Note</h5>
                                <p class="card-text">Adding note to a task is useful. It keeps you on track of your progress. Just start typing within the task then hit "Enter" when you're done.</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                    ...
                    <div class="carousel-item">
                        <div class="card border-0 rounded-0">
                            <img src="<?= base_url('assets/tutorial/archive.png') ?>" alt="Account" class="rounded-0 card-img-top">
                            <div class="card-body">
                                <h5 class="card-title">Archiving Task</h5>
                                <p class="card-text">Once you're done with the task, just click the archive icon at the button of the task tile.</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
